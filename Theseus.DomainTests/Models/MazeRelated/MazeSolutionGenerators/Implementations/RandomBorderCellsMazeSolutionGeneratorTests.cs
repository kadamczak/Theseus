...
{
    public class RandomBorderCellsMazeSolutionGeneratorTests
    {
        public static IEnumerable<object[]> Generate_Data => new List<object[]>
            {
                new object[] { new Maze(5, 6), 46, MazeStructureGenAlgorithm.HuntAndKill, true,  (4, 1), (0, 4)},
                new object[] { new Maze(8, 6), 50, MazeStructureGenAlgorithm.AldousBroder, true,  (7, 2), (2, 5)},
                new object[] { new Maze(7, 7), 30, MazeStructureGenAlgorithm.TruePrim, false,  (2, 0), (5, 0)},
            };
                                                          ...
                                                          (int row, int column) expectedEndCellCoordinates)
        {
            ...
            var mazeSolutionGenerator = new RandomBorderCellsMazeSolutionGenerator(gridFactory, shouldExcludeCellsCloseToRoot);

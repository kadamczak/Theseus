...
{
    public class BinaryTreeMazeStructureGeneratorTests
    {
        public static IEnumerable<object[]> GenerateMazeStructure_Data => new List<object[]>
            {
                ...
                new object[] { new Maze(8, 12), 44, (6, 3), new List<Direction>() { Direction.West, Direction.North, Direction.South } },
                new object[] { new Maze(8, 12), 44, (6, 9), new List<Direction>() { Direction.East, Direction.South } },
                ...
                new object[] { new Maze(5, 3), 40, (3, 1), new List<Direction>() { Direction.West, Direction.North, Direction.South } },
                new object[] { new Maze(5, 3), 40, (0, 2), new List<Direction>() { Direction.West, Direction.South, } },
                new object[] { new Maze(5, 3), 40, (2, 1), new List<Direction>() { Direction.West, Direction.East, Direction.South } },
            };
                                                                   ...
                                                                   List<Direction> expectedDirectionsOfAllLinkedNeighbours)
        {
            ...
            var generator = new BinaryTreeMazeStructureGenerator();

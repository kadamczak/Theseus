...
{
    public class TruePrimMazeStructureGeneratorTests
    {
        public static IEnumerable<object[]> GenerateMazeStructure_Data => new List<object[]>
            {
                new object[] { new Maze(8, 12), 44, (0, 0), new List<Direction>() { Direction.South } },
                new object[] { new Maze(8, 12), 44, (6, 3), new List<Direction>() { Direction.East, Direction.West, Direction.South } },
                new object[] { new Maze(8, 12), 44, (6, 9), new List<Direction>() { Direction.West, Direction.South } },
                new object[] { new Maze(8, 12), 44, (7, 11), new List<Direction>() { Direction.West, Direction.North } },
                new object[] { new Maze(8, 12), 44, (0, 6), new List<Direction>() { Direction.West, Direction.East } },

                new object[] { new Maze(5, 3), 40, (3, 1), new List<Direction>() { Direction.South, Direction.North, Direction.East, Direction.West } },
                new object[] { new Maze(5, 3), 40, (0, 2), new List<Direction>() { Direction.South, Direction.West } },
                new object[] { new Maze(5, 3), 40, (2, 1), new List<Direction>() { Direction.South, Direction.East, Direction.North, Direction.West } },
            };
                                                                   ...
                                                                   List<Direction> expectedDirectionsOfAllLinkedNeighbours)
        {
            ...
            var generator = new TruePrimMazeStructureGenerator();

...
{
    public class SidewinderMazeStructureGeneratorTests
    {
        public static IEnumerable<object[]> GenerateMazeStructure_Data => new List<object[]>
            {
                ...
                new object[] { new Maze(8, 12), 44, (6, 3), new List<Direction>() { Direction.East, Direction.South } },
                new object[] { new Maze(8, 12), 44, (6, 9), new List<Direction>() { Direction.West, Direction.East, Direction.North } },
                new object[] { new Maze(8, 12), 44, (7, 11), new List<Direction>() { Direction.North } },
                new object[] { new Maze(8, 12), 44, (0, 6), new List<Direction>() { Direction.West, Direction.East, Direction.South } },

                new object[] { new Maze(5, 3), 40, (3, 1), new List<Direction>() { Direction.East, Direction.North, Direction.South } },
                new object[] { new Maze(5, 3), 40, (0, 2), new List<Direction>() { Direction.West } },
                new object[] { new Maze(5, 3), 40, (2, 1), new List<Direction>() { Direction.North, Direction.South } },
            };
                                                                   ...
                                                                   List<Direction> expectedDirectionsOfAllLinkedNeighbours)
        {
            ...
            var generator = new SidewinderMazeStructureGenerator();

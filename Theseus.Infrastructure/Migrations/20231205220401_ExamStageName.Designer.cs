...
namespace Theseus.Infrastructure.Migrations
{
    ...
    [Migration("20231205220401_ExamStageName")]
    partial class ExamStageName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Theseus.Infrastructure.Dtos.ExamDto", b =>
                {
                    ...
                    b.HasOne("Theseus.Infrastructure.Dtos.PatientDto", "PatientDto")
                        .WithMany()
            ...
            modelBuilder.Entity("Theseus.Infrastructure.Dtos.ExamStageDto", b =>
                {
                    b.HasOne("Theseus.Infrastructure.Dtos.ExamDto", "ExamDto")
                        .WithMany("StageDtos")
                        .HasForeignKey("ExamDtoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ExamDto");
                });

            modelBuilder.Entity("Theseus.Infrastructure.Dtos.ExamStepDto", b =>
                {
                    b.HasOne("Theseus.Infrastructure.Dtos.ExamStageDto", "StageDto")
                        .WithMany("StepDtos")
                        .HasForeignKey("StageDtoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StageDto");
                });

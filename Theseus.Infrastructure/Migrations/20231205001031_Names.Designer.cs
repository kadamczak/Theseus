...
namespace Theseus.Infrastructure.Migrations
{
    ...
    [Migration("20231205001031_Names")]
    partial class Names
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Theseus.Infrastructure.Dtos.ExamStepDto", b =>
                {
                    b.HasOne("Theseus.Infrastructure.Dtos.ExamStageDto", "StageDtos")
                        .WithMany("StepDtos")
                        .HasForeignKey("StageDtosId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
